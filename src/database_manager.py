...
class dcGODatabaseManager:
    ...
    def _initialize_database(self) -> None:
        ...
        with self.get_connection() as conn:
            ...
            cursor.execute('CREATE INDEX IF NOT EXISTS idx_fdr_q_value ON domain_annotations(fdr_q_value)')
            cursor.execute('CREATE INDEX IF NOT EXISTS idx_association_score ON domain_annotations(association_score)')
            cursor.execute('CREATE INDEX IF NOT EXISTS idx_direct_source ON domain_annotations(direct_source_term)')
            cursor.execute('CREATE INDEX IF NOT EXISTS idx_domain_type ON domain_annotations(domain_id, annotation_type)')
    ...
    def _validate_schema(self) -> None:
        ...
        with self.get_connection() as conn:
            ...
            required_tables = {'domain_annotations', 'association_statistics', 'pipeline_metadata'}
    ...
    def store_annotations(self, annotations: List[Any], metadata: Optional[Dict[str, Any]] = None,
                         statistics: Optional[List[Dict[str, Any]]] = None) -> None:
        """
        ...
        try:
            with self.get_connection() as conn:
                ...
                try:
                    ...
                    annotation_tuples = [
                        (ann['domain_id'], ann['go_id'], ann['fdr_q_value'], 
                         ann['association_score'], ann['annotation_type'], ann['direct_source_term'])
                    ...
                    if statistics:
                        ...
                        stats_tuples = [
                            (stat['domain'], stat['go_term'], stat['a'], stat['b'], 
                             stat['c'], stat['d'], stat['odds_ratio'], stat['p_value'], 
    ...
    def export_tsv(self, output_path: Union[str, Path], 
        ...
        try:
            with self.get_connection() as conn:
                ...
                query_parts.append("ORDER BY domain_id, annotation_type, association_score DESC")
    ...
    def get_summary_statistics(self) -> Dict[str, Any]:
        ...
        try:
            with self.get_connection() as conn:
                ...
                cursor = conn.execute("SELECT COUNT(DISTINCT direct_source_term) FROM domain_annotations")
                ...
                cursor = conn.execute("SELECT key, value, data_type FROM pipeline_metadata")
                metadata = {}
    ...
    def query_annotations(self, domain_id: Optional[str] = None,
    ...
    def get_database_info(self) -> Dict[str, Any]:
        ...
        try:
            with self.get_connection() as conn:
                ...
                # Database settings
                settings = {}
                for pragma in ['journal_mode', 'synchronous', 'temp_store', 'mmap_size']:
...
if __name__ == "__main__":
    ...
    with dcGODatabaseManager(db_path) as db:
        ...
        test_annotations = [
            MockAnnotation("PF00001", "GO:0003677", 0.001, 85.5, "direct", "GO:0003677"),
            MockAnnotation("PF00001", "GO:0003674", 0.001, 85.5, "propagated", "GO:0003677"),
            MockAnnotation("PF00002", "GO:0008150", 0.005, 72.3, "direct", "GO:0008150"),
        ]
