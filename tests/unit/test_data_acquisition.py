...
class TestDataAcquisition:
    ...
    @patch("requests.get")
    def test_download_with_progress_success(
        self, mock_get, data_acquisition, temp_data_dir
    ):
    ...
    @patch("requests.get")
    def test_download_with_progress_failure(
        self, mock_get, data_acquisition, temp_data_dir
    ):
    ...
    @patch.object(DataAcquisition, "download_with_progress")
    def test_download_all_datasets_partial_failure(
        self, mock_download, data_acquisition
    ):
    ...
    def test_cleanup_old_downloads(self, data_acquisition, temp_data_dir):
        ...
        assert (
            len(removed_files) >= 0
        )  # May be 0 if filesystem doesn't support old timestamps
