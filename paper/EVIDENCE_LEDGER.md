...
| K8 | Current component ablation | Supra-domains: F_max significant in 0/9 one-component cells; relative inference added to supra lowers F_max and AUPRC in 9/9 cells (8/9 significant for each); output propagation added to supra raises F_max in 7/9 cells (1 significant), with mixed AUPRC; all 18 supra-vs-permutation metric cells have empirical p = 1/201 | `validation/ablation_metrics.tsv`, `validation/ablation_paired_bootstrap.tsv`, `validation/ablation_permutation_null.tsv`, and `validation/ablation_manifests/` | Commit `3f37558`; archived GOA release 205 → current experimental GOA; nine full inference configurations; 1,000 paired protein bootstraps; 200 domain-label permutations | supported |
